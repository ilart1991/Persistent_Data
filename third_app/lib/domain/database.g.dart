    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Person` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `family` TEXT NOT NULL, `age` INTEGER NOT NULL, `avatar` TEXT NOT NULL, `phone` TEXT NOT NULL, `cardNum` TEXT NOT NULL, PRIMARY KEY (`id`))');
